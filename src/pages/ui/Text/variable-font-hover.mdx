...
Implementing a Variable Font Hover component using Next.js and Tailwind CSS. Took the inspiration from [@WebBae](https://variable-font-weight-hover.webflow.io/).
